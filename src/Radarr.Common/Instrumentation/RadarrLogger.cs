...
{
    public static class RadarrLogger
    {
        ...
        private static void RegisterDebugger()
        {
            ...
            target.Layout =
                "[${level}] [${threadid}] ${logger}: ${message} ${onexception:inner=${newline}${newline}[v${assembly-version}] ${exception:format=ToString}${newline}}";
        ...
        {
            var fileTarget = new RadarrFileTarget();
        ...
        {
            return LogManager.GetLogger(obj.Name.Replace("Radarr.", ""));
        }
