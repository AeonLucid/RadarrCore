...
namespace Radarr.Common.Extensions
{
    public static class PathExtensions
    {
        ...
        private const string NZBDRONE_DB = "radarr.db";
        ...
        public static string CleanFilePath(this string path)
        {
            ...
            if (OsInfoCore.IsWindows && info.FullName.StartsWith(@"\\")) //UNC
            {
        ...
        public static bool PathEquals(this string firstPath, string secondPath, StringComparison? comparison = null)
        {
            ...
            {
                comparison = OsInfoCore.PathStringComparison;
            }
        ...
        public static bool IsParentPath(this string parentPath, string childPath)
        {
            ...
            {
                if (child.Parent.FullName.Equals(parent.FullName, OsInfoCore.PathStringComparison))
                {
                    return true;
                }
        ...
        {
            if (!OsInfoCore.IsWindows || path.StartsWith("\\"))
            {
                return path;
            }
